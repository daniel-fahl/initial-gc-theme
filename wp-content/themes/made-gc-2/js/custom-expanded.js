...
jQuery(window).load(function() {
	//latest slider	
	jQuery(function() {
		jQuery("#feature-wrapper .latest").jCarouselLite({		
			btnNext: "#feature-wrapper .latest-next",		
			btnPrev: "#feature-wrapper .latest-prev",
	...
	jQuery(function() {
		jQuery("#feature-wrapper .latest.responsive").jCarouselLite({		
			btnNext: "#feature-wrapper .latest-next",		
			btnPrev: "#feature-wrapper .latest-prev",
			easing: "easeInOutExpo",
			speed: 700,
	...
	jQuery(function() {
		jQuery("#video_playlist").jCarouselLite({		
			btnNext: "#video-wrapper .latest-next",		
			btnPrev: "#video-wrapper .latest-prev",
			easing: "easeInOutExpo",
			speed: 700,
			visible: 5,
			scroll: 5,
