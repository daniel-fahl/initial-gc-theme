...
if($oswc_author_exclude=="") {
	...
	$excluded_string = substr($excluded_string,0,-1); //remove last comma	
                ...
                <div id="authorbox" class="categorypanel<?php if($postcount % 2 == 0) { ?> right<?php } ?>"> 
                    ...
                    <div class="inner">                      
                        ...
                        <ul class="social-links">
                            ...
                            <li class="url"><a title="<?php _e( 'Website', 'made' ); ?>" href='<?php the_author_meta('user_url', $author->post_author); ?>'>&nbsp;</a></li>
                            <?php endif; ?>                     
                        </ul>
