...
if($oswc_dontmiss_type=="tag") {
	...
	$terms = get_terms('post_tag', array('slug' => $oswc_dontmiss_tags)); //get term object for this tag
	...
	$terms = get_terms('category', array('slug' => $oswc_dontmiss_tags)); //get term object for this category
    ...
    <div id="dontmiss-bar">
        ...
        <div id="dontmiss-email" class="signup">
        	...
        	<?php if($oswc_dontmiss_widget_type=="Signup") { ?>
            	...
            	<form action="http://gamechurch.us2.list-manage.com/subscribe/post?u=146f056be682f9f73aa7da93e&amp;id=f12080a3d7" method="post" class="subscribe" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
            	<div class="email-wrapper">
            		...
            		<input type="image" src="<?php echo get_template_directory_uri(); ?>/images/signup.png" class="btn" title="<?php _e('You will receive a daily email with new content from our website.','made'); ?>" />
            	</form>
            ...
            <?php }else{ ?>
				...
				`
					...
					<form action="http://gamechurch.us2.list-manage.com/subscribe/post?u=146f056be682f9f73aa7da93e&amp;id=f12080a3d7" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
