...
if($oswc_latest_type=="tag") {
	...
	$terms = get_terms('post_tag', array('slug' => $oswc_latest_tag)); //get term object for this tag
	...
	$terms = get_terms('category', array('slug' => $oswc_latest_tag)); //get term object for this category
                    ...
                    <ul> 	
                        ...
                        if (have_posts()) : while (have_posts()) : the_post();					
                            ...
                            <li>
                                ...
                                <a class="darken small<?php if($isvideo) { ?> video<?php } ?> imgwrap" href="<?php the_permalink(); ?>"><?php the_post_thumbnail('latest', array( 'title'=> '' )); ?></a>
