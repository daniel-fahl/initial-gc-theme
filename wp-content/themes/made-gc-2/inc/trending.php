...
if($oswc_trending_type=="tag") {
	...
	$terms = get_terms('post_tag', array('slug' => $oswc_trending_tag)); //get term object for this tag
	...
	$terms = get_terms('category', array('slug' => $oswc_trending_tag)); //get term object for this category
