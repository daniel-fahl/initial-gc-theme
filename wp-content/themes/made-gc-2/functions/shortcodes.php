...
function oswc_toggle_simple($atts, $content = null) {
	...
	return '<h3 class="toggle">'.$title.'</h3><div class="toggle-content" style="width:'.$width.'px;">'.do_shortcode($content).'</div>';
}
...
function oswc_toggle_box($atts, $content = null) {
	...
	return '<div class="toggle-box-wrapper"><div class="toggle-box"><h3 class="toggle">'.$title.'</h3><div class="toggle-content" style="width:'.$width.'px;">'.do_shortcode($content).'</div></div></div>';
}
