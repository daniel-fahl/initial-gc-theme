...
if ( !class_exists('myCustomFields') ) {  
    ...
    class myCustomFields {  
        ...
        */  
        var $postTypes = array( "page", "post", "merch", "video" );  
        /** 
        ...
        */  
        var $customFields = array( 
			array(
				"name"			=> "paypal_code",
				"title"			=> "Paypal Code",
				"description"	=> "Paste the paypal code here.",
				"type"			=> "textarea",
				"scope"			=>	array( "merch" ),
			...
			array(
				"name"			=> "embed1",
				"title"			=> "Embed Code",				
				"description"	=> "Insert any embed or html code here",
				"type"			=> "textarea",
				"scope"			=>	array( "page" ),
				"capability"	=> "edit_posts",
			),
			array(
				"name"			=> "embed2",
				"title"			=> "Additional Embed Code",				
				"description"	=> "Insert any additional embed or html code here",
				"type"			=> "textarea",
				"scope"			=>	array( "page" ),
				"capability"	=> "edit_posts",
			),
