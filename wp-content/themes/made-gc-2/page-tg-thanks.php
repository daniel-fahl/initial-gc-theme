<?php
// Template Name: ThanksGaming - Thanks
?>
...
<div id="close" class="modalDialog">
	<div>
		<a href="#close" title="Close" class="close"></a>
		<h2>ThanksGaming thanks YOU for being a super awesome person!</h2>
		<p></p>
		<p>As you know, needy families and individuals in our community go without adequate food every day due to a variety of factors including low wages, job loss, injuries, illness, age, domestic violence, or divorce. While all of us are susceptible to hard times, children and the elderly are at the most risk.</p>
		
		<p>Our recipient charity this year is Mercy Ministries International (<a href="http://mercyministriesinternations.com">mercyministriesinternational.com</a>), and their local food bank in El Rio, CA. Their vision is to “…provide food, clothing, shelter, a safe place to sleep, counseling, vocational training, and hope, in order to enable people to re-enter society as individuals with dignity”, and they’re doing it every day with the generous support of people like you.</p>
		
		<p>You contribution this year will go to help some of these families have a brighter holiday this holiday season by providing a full Thanksgiving dinner for a family, that otherwise would go without on this special day of family and community.</p> 
		
		<p>Thank you again, and we look forward to your continued support next year at ThanksGaming 2013!</p>
	</div>
</div>
...
<div id="main_wrapper">
	...
	<div id="main" class="clearfix">
		...
		<form action="http://gamechurch.us2.list-manage2.com/subscribe/post?u=146f056be682f9f73aa7da93e&amp;id=25519663e7" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
			<label for="mce-EMAIL">Get Updates on ThanksGaming!</label>
