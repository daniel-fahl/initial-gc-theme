...
<head profile="http://gmpg.org/xfn/11">
	...
	if(is_front_page()) { ?>
    	<style type="text/css">	
			...
			#top-menu ul li a:hover, #top-menu ul li:hover a, #top-menu ul li.over a {color: #000;}
    ...
    <?php 
    	...
    	wp_enqueue_script( 'scripts', get_bloginfo('template_url') . '/js/scripts.js', array('jquery') , '1', true);
    	wp_enqueue_script( 'affix', get_bloginfo('template_url') . '/js/affix.js', array('jquery') , '1', true);	
    	wp_enqueue_script( 'ajax', get_bloginfo('template_url') . '/js/ajax.js', array('jquery') , '1', true);	
    	wp_enqueue_script( 'stellar', get_bloginfo('template_url') . '/js/jquery.stellar.min.js', array('jquery') , '1', true);	
    ?>
...
<body <?php body_class($skin); ?> data-slide="1" data-stellar-background-ratio="0.4">

	<?php oswc_get_template_part('demo-panel'); ?>
	
	<div class="bodyshadows"></div>
	...
	<div id="page-wrapper"> <!-- everything below the top menu should be inside the page wrapper div -->
                    ...
                    <div id="logo"><!--logo and section header area-->
                        ...
                        <?php if($oswc_logo != "") { ?>
                            <a href="<?php echo home_url(); ?>/">
                                <img id="site-logo" alt="<?php bloginfo('name'); ?>" src="<?php bloginfo('template_url'); ?>/images/logo.png" />
                                <img id="site-logo-iphone" alt="<?php bloginfo('name'); ?>" src="<?php bloginfo('template_url'); ?>/images/logo-mobile.png" />
                                <img id="site-logo-ipad" alt="<?php bloginfo('name'); ?>" src="<?php bloginfo('template_url'); ?>/images/logo.png" />
                            </a>
                        <?php } else { ?>     
        ...
        <div id="cat-menu" class="cat-menu" data-spy="affix" data-offset-top="130">
