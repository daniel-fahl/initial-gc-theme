...
?>
        ...
        <div id="footer">
        	...
        	<?php if(!$oswc_footer_menu_hide) { //the menu in the footer ?>
                ...
                <div class="footer-menu">
                    ...
                    $menu = wp_nav_menu( array( 'theme_location' => 'footer-menu', 'container' => '0', 'fallback_cb' => 'fallback_footer_menu', 'echo' => '0', 'depth' => 1 ) );
    ...
    <script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/js/custom-expanded.js"></script> <!-- made js -->   
